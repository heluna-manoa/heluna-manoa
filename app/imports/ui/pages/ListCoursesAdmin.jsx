    ...
    <Container className="top-navbar-margin">
      <Row className="justify-content-center">
        <Col md={7}>
          ...
          <h2 style={{ color: 'white' }}><Button id="add-course" variant="primary" onClick={routeChange}><PlusCircleFill /> Add Course</Button></h2>
          <h2 style={{ color: 'white' }}><Button id="add-professor" variant="primary" onClick={routeChange2}><PlusCircleFill /> Add Professor</Button></h2>
        </Col>
      </Row>
    </Container>
  ) : <LoadingSpinner />);
